 ...
 * @return string
 */
function harmonica_get_content_template() {
	...
	$templates = apply_filters( 'harmonica_content_template_hierarchy', $templates );

	/* Apply filters and return the found content template. */
	include( apply_filters( 'harmonica_content_template', locate_template( $templates, false, false ) ) );
}
 ...
 * @return void
 */
function harmonica_get_menu( $name = '' ) {
 ...
 * @return void
 */
function harmonica_get_sidebar( $name = null ) {
