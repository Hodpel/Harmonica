...
add_filter( 'wp_link_pages_args', 'harmonica_link_pages_args', 5 );
add_filter( 'wp_link_pages_link', 'harmonica_link_pages_link', 5 );

/* Filters to add microdata support to common template tags. */
add_filter( 'the_author_posts_link',          'harmonica_the_author_posts_link',          5 );
add_filter( 'get_comment_author_link',        'harmonica_get_comment_author_link',        5 );
add_filter( 'get_comment_author_url_link',    'harmonica_get_comment_author_url_link',    5 );
add_filter( 'comment_reply_link',             'harmonica_comment_reply_link_filter',      5 );
add_filter( 'get_avatar',                     'harmonica_get_avatar',                     5 );
add_filter( 'post_thumbnail_html',            'harmonica_post_thumbnail_html',            5 );
add_filter( 'comments_popup_link_attributes', 'harmonica_comments_popup_link_attributes', 5 );
 ...
 * @return array
 */
function harmonica_link_pages_args( $args ) {
 ...
 * @return string
 */
function harmonica_link_pages_link( $link ) {
 ...
 * @return string
 */
function harmonica_the_author_posts_link( $link ) {
 ...
 * @return string
 */
function harmonica_get_comment_author_link( $link ) {
 ...
 * @return string
 */
function harmonica_get_comment_author_url_link( $link ) {
 ...
 * @return string
 */
function harmonica_comment_reply_link_filter( $link ) {
 ...
 * @return string
 */
function harmonica_get_avatar( $avatar ) {
 ...
 * @return string
 */
function harmonica_post_thumbnail_html( $html ) {
 ...
 * @return string
 */
function harmonica_comments_popup_link_attributes( $attr ) {
