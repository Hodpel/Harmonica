...
add_filter( 'image_size_names_choose', 'harmonica_image_size_names_choose' );
 ...
 * @return array $sizes
 */
function harmonica_image_size_names_choose( $sizes ) {
	...
	foreach ( $intermediate_sizes as $size )
		$add_sizes[ $size ] = 'post-thumbnail' === $size ? __( 'Post Thumbnail', 'harmonica' ) : $size;
