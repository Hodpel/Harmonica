...
add_filter( 'date_template', 'harmonica_date_template' );

/* Filter the author/user template. */
add_filter( 'author_template', 'harmonica_user_template' );

/* Filter the tag and category (taxonomy) templates. */
add_filter( 'tag_template', 'harmonica_taxonomy_template' );
add_filter( 'category_template', 'harmonica_taxonomy_template' );
add_filter( 'taxonomy_template', 'harmonica_taxonomy_template' );

/* Filter the single, page, and attachment (singular) templates. */
add_filter( 'single_template', 'harmonica_singular_template' );
add_filter( 'page_template', 'harmonica_singular_template' );
add_filter( 'attachment_template', 'harmonica_singular_template' );

/* Filter the comments template. */
add_filter( 'comments_template', 'harmonica_comments_template' );
 ...
 */
function harmonica_date_template( $template ) {
	$templates = array();
 ...
 */
function harmonica_user_template( $template ) {
	$templates = array();
 ...
 * @return string Full path to file.
 */
function harmonica_taxonomy_template( $template ) {
 ...
 */
function harmonica_singular_template( $template ) {
 ...
 */
function harmonica_comments_template( $template ) {
