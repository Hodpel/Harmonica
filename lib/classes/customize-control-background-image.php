...
class harmonica_Customize_Control_Background_Image extends WP_Customize_Background_Image_Control {
	...
	public function __construct( $manager ) {
		...
		$this->default_backgrounds = apply_filters( 'harmonica_default_backgrounds', $this->default_backgrounds );
		...
		if ( !$this->setting->default && !empty( $this->default_backgrounds ) )
			$this->add_tab( 'default', _x( 'Default', 'theme customizer tab', 'harmonica' ), array( $this, 'tab_default_background' ) );
	}
