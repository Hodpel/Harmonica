...
add_action( 'customize_register', 'harmonica_customize_css_register' );
 ...
 */
function harmonica_customize_css_register( $wp_customize ) {

	/* Add the section. */
	$wp_customize->add_section(
		'css',
		array(
			'title'      => esc_html__( 'CSS', 'harmonica' ),
			'priority'   => 150,
	...
	$wp_customize->add_setting(
		...
		array(
			...
			'sanitize_callback'    => 'harmonica_custom_css_sanitize',
	...
	$wp_customize->add_control(
		new harmonica_Customize_Control_Textarea(
			$wp_customize,
			'custom_css',
			array(
				'label'   		=> '',
	...
	if ( $wp_customize->is_preview() && !is_admin() ) {
		add_action( 'wp_footer', 'harmonica_customize_preview_script', 22 );
	}
}
 ...
 * @access private
 */
function harmonica_customize_preview_script() {
 ...
 * @access private
 */
function harmonica_custom_css_sanitize($css) {
