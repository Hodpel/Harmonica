...
add_action( 'customize_register', 'harmonica_customize_post_register' );
 ...
 */
function harmonica_customize_post_register( $wp_customize ) {
...
add_action('customize_controls_print_scripts', 'harmonica_customize_post_script');

function harmonica_customize_post_script() {
?>
