harmonica WordPress Theme
---------------------
harmonica is a parent theme for WordPress and harmonica child
...
Install
-------
1. Upload the harmonica folder via FTP to your wp-content/themes/ directory.
...
Source: https://wordpress.org/themes/harmonica/
...
harmonica WordPress Theme is derived from Hybrid Core, Copyright Justin Tadlock, justintadlock.com.
Hybrid Core is distributed under the terms of the GNU GPL

harmonica WordPress Theme incorporates code from Underscores WordPress Theme, Copyright 2013 Automattic, Inc.
...
harmonica WordPress Theme bundles the following third-party resources:
...
1.1.2
- add placeholder attribute to harmonica_Customize_Control_Textarea class
...
1.1.0
- fix harmonica_attr_entry_content schema property
...
1.0.6
- add harmonica_before_loop action
- add favicon
- fixed blog layout option

1.0.5
- add harmonica_after_loop action
...
- move theme options to harmonica options plugin
...
0.9.4
- remove if class_exists( 'harmonica' )
...
- add do_action( 'harmonica_content' ); // harmonica_content
...
0.7.0   2013-10-06
- Updated harmonica hook filters 
- updated 404.php
...
- fixed harmonica_footer_insert
- apply filter for entry byline and entry meta
- added harmonica wrap
...
- move harmonica child theme to wordpress.org/themes/harmonica-child
...
0.3.2	2013-08-10
- disabled harmonica_meta_template
...
0.3.0	2013-08-03
- add sample harmonica child theme
- cleaned up files and functions
- add schema.org markup
- Introduced harmonica actions
