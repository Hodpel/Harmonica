<div class="entry-meta">
	...
	<?php echo '<a href="' . get_permalink() . '#comments">' . harmonica_comments_users($post->ID,1) . ' Comments</a> | <i class="fa fa-eye" aria-hidden="true"></i> ' . getPostViews( get_the_ID() ) . ' Views | '?>
